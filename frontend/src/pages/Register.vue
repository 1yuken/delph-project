...
<template>
  <div class="flex flex-col items-center justify-center w-full bg-[#F9F9F9] py-12 px-4">
    <div class="w-full max-w-md bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
      <!-- Вкладки навигации -->
      ...
      <div class="p-6 sm:p-8">
        ...
        <p class="text-[#656565] text-sm text-center mb-6">
          Присоединяйтесь к нашему сообществу
        </p>
        
        <!-- Сообщение об успешной регистрации -->
        <div v-if="registrationSuccess" class="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg animate-fadeIn">
        ...
        <form v-else class="space-y-4" @submit.prevent="register">
          <!-- Поле имени -->
          <div class="space-y-1">
            <label for="fullName" class="block text-sm font-medium text-[#222222]">Имя или псевдоним</label>
            <div class="relative">
          ...
          <!-- Поле email -->
          <div class="space-y-1">
            <label for="email" class="block text-sm font-medium text-[#222222]">Электронная почта</label>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <input
                ...
                :class="[
                  isEmailValid ? 'border-[#E5E9F2] focus:border-[#0A65CC]' : 'border-red-500 focus:border-red-500'
                ]"
                required
              />
          ...
          <div class="space-y-1">
            <label for="passwordConfirm" class="block text-sm font-medium text-[#222222]">Подтверждение пароля</label>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <Lock class="h-5 w-5 text-[#656565]" />
              </div>
              <input
                ...
                :class="[
                  passwordsMatch ? 'border-[#E5E9F2] focus:border-[#0A65CC]' : 'border-red-500 focus:border-red-500'
                ]"
                required
              />
              <button 
          ...
          <div class="flex items-start mt-4 cursor-pointer">
            ...
            <div class="ml-3 text-sm">
              <label for="terms" class="text-[#656565]">
                ...
                <a href="#" class="text-[#0A65CC] hover:text-[#085BBA] transition-colors duration-200">
          ...
          <div class="grid grid-cols-3 gap-3">
            ...
            >
              <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M8 12H16M16 12L12 8M16 12L12 16" stroke="#1877F2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </button>
            <button
              type="button"
            ...
            >
              <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M8 12L11 15L16 9" stroke="#0088CC" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </button>
            <button
              type="button"
            ...
            >
              <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12Z" stroke="#EA4335" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </button>
          </div>
        </form>

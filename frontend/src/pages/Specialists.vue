...
const specialists = ref([
  {
    id: 1,
    image: '/public/avatar-full.jpg',
    title: 'Разработка на Vue.js',
    username: 'yuken',
    rating: 5,
    reviewCount: 21,
    skills: ['Vue', 'JavaScript', 'Vite', 'Nuxt.js', 'TypeScript', 'SCSS', 'Docker'],
    lastActive: '2023-05-15T10:30:00',
    completedProjects: 47
  },
  {
    id: 2,
    image: '/public/random2.jpg',
    title: 'Frontend разработка',
    username: 'alex_dev',
    rating: 4.8,
    reviewCount: 34,
    skills: ['React', 'JavaScript', 'TypeScript', 'Next.js', 'Tailwind CSS', 'Redux', 'GraphQL'],
    lastActive: '2023-05-16T14:20:00',
  ...
  },
  {
    ...
    rating: 4.9,
    reviewCount: 28,
    skills: ['Vue', 'Node.js', 'Express', 'MongoDB', 'REST API', 'Docker', 'AWS'],
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 42,
    skills: ['Figma', 'Adobe XD', 'UI/UX', 'Sketch', 'Prototyping', 'HTML', 'CSS'],
    lastActive: '2023-05-17T11:45:00',
  ...
  },
  {
    ...
    username: 'server_guru',
    rating: 4.6,
    reviewCount: 19,
    skills: ['Python', 'Django', 'PostgreSQL', 'Docker', 'Redis', 'Celery', 'AWS'],
    lastActive: '2023-05-13T16:30:00',
  ...
  <div class="relative w-full md:w-4/5 lg:w-3/5 mx-auto py-4 md:py-5 px-4 md:px-6">
    <div class="flex flex-col w-full">
      <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0 mb-6">
        ...
        <div class="flex flex-wrap items-center gap-3 w-full sm:w-auto">
          ...
          >
            ...
            <span>Фильтры</span>
            <span v-if="selectedSkills.length" class="ml-1 px-1.5 py-0.5 bg-[#0A65CC] text-white text-xs rounded-full">
          ...
          <div class="relative flex-grow sm:flex-grow-0">
            ...
            <div class="absolute right-3 top-1/2 transform -translate-y-1/2 pointer-events-none">
              <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 1L5 5L9 1" stroke="#656565" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
            </div>
          </div>
        </div>
              ...
              >
                ...
                <button @click="toggleSkill(skill)" class="ml-1 hover:text-gray-200 cursor-pointer">
                  <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L7 7M1 7L7 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                  </svg>
                </button>
              </div>
            </div>
      ...
      <div v-else class="flex flex-col items-center justify-center py-8 md:py-12 text-center">
        ...
        <button @click="clearFilters" class="px-4 py-2 bg-[#0A65CC] text-white rounded-md hover:bg-[#085BBA] transition-colors cursor-pointer">
          Сбросить фильтры
        </button>
      </div>
    </div>

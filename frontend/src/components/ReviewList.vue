...
<template>
  <div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
      <!-- Средний рейтинг -->
      <div class="bg-[#F9F9F9] rounded-lg p-4 border border-[#E5E9F2] flex flex-col items-center justify-center">
        ...
        <div class="flex mt-2">
          <StarIcon v-for="i in 5" :key="i" :class="i <= Math.round(averageRating) ? 'text-[#FFB800]' : 'text-[#E5E9F2]'" />
        </div>

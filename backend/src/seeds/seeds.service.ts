    ...
    const users = [
      {
        ...
        avatarUrl: 'http://localhost:3000/uploads/janedoe.jpg',
        isActive: true,
        isFreelancer: false,
      },
      {
        ...
        avatarUrl: 'http://localhost:3000/uploads/admin.jpg',
        isActive: true,
        isFreelancer: false,
      },
      {
        username: 'илюха',
        email: 'iluha@delph.com',
        password: await bcrypt.hash('password123', 10),
        avatarUrl: 'http://localhost:3000/uploads/iluha.jpg',
        skills: ['C++', 'C--', 'Holy C', 'C#', 'Сеньор'],
        bio: '@KopoJlb_B_CeTu',
        isActive: true,
        isFreelancer: true,
      },
      {
        username: 'mahmud',
        email: 'abasenov@delph.com',
        password: await bcrypt.hash('password123', 10),
        avatarUrl: 'http://localhost:3000/uploads/mahmud.jpg',
        isActive: true,
        isFreelancer: true,
      },
      {
        username: 'gamid',
        email: 'gamid@delph.com',
        password: await bcrypt.hash('password123', 10),
        avatarUrl: 'http://localhost:3000/uploads/gamid.jpg',
        isActive: true,
        isFreelancer: false,
      },
      {
        username: 'chotkiy',
        email: 'chotkiy@delph.com',
        password: await bcrypt.hash('password123', 10),
        avatarUrl: 'http://localhost:3000/uploads/chotkiy.jpg',
        isActive: true,
        isFreelancer: false,
      },
    ];
